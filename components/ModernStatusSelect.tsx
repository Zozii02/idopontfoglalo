  ...
  return (
    <div className="relative inline-block w-full max-w-[130px]">
      <select 
        ...
        className={`appearance-none w-full text-[10px] uppercase font-bold tracking-wider px-2 py-1 pr-5 rounded-md outline-none cursor-pointer border shadow-sm transition-all focus:ring-1 focus:ring-offset-1 ${currentStyle}`}
      >
